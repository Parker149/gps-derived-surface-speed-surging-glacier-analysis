...
addpath('/Volumes/volume/CautoRift/advection_analysis/GPS_Sample_Locations/Ice12_2008_50m-interval/')
...
% -- Load all rasters -- 
rasterFolder = '/Volumes/volume/CautoRift/advection_analysis/velocity/jukes_20_9to10/';
...
num_points = length(GPS4vel.clean_date);
...
h3 = plot(dist_from_deploy, GPS4vel.filt_speed, '-', ...
...
ave_GPS = mean(GPS4vel.filt_speed);
...
GPS_max_diff = max(abs(ave_GPS - GPS4vel.filt_speed));
