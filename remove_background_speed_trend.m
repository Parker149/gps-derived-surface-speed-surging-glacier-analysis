...
dataDir = '/Volumes/volume/Data/The_GPS_Archive/SK/Filtered_Velocities_FINAL/';

% -- Load all data and create name for looping -- 
site_V = load_data_and_create_name_FILTERED(dataDir);

% -- Some records need to be trimmed slightly to remove edge effects -- 
G11_2108 = G11_2108(15000:245000,:);
G11_2208 = G11_2208(1:413000,:); 
G15_2308 = G15_2308(1:151000,:); 
...
for p = 1:length(site_V)
    ...
    %initial data
    x = eval(site_V{p}).clean_date;
    y = eval(site_V{p}).filt_speed;
...
saveDir = '/Volumes/volume/Data/The_GPS_Archive/SK/Detrended/'; % <------ input here [directory path]
